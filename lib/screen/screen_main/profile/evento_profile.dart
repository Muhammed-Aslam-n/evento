  ...
  buildUpdateUsernameBottomSheet() {
    ...
    Get.bottomSheet(
      Container(
        decoration: const BoxDecoration(
          color: whiteColor,
          borderRadius: BorderRadius.only(topLeft: dayContainerRadius,topRight: dayContainerRadius)
        ),
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                DataInputField(hintText: "New Username",controller: EventoController.eventoController.newUsernameController,minLength: 5,maxLength: 15,prefixIcon: Icons.person,),
                SizedBox(
                  height: 20.h,
                ),
                TextButton(onPressed: (){
                  Get.back();
                  EventoController.eventoController.commonSnackBar("Username", "Username Updated Successfully");
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                const CommonText(text: "Update Password",size: 18,color: primaryTextColor,),
                SizedBox(
                  height: 5.h,
                ),
                DataInputField(hintText: "Current Password",controller: EventoController.eventoController.passwordEditingController,minLength: 5,maxLength: 8,prefixIcon: Icons.password_outlined,),
                SizedBox(
                  height: 5.h,
                ),
                DataInputField(hintText: "New Password",controller: EventoController.eventoController.newPasswordController,minLength: 5,maxLength: 8,prefixIcon: Icons.password_outlined,),
                SizedBox(
                  height: 20.h,
                ),
                TextButton(onPressed: (){
                  Get.back();
                  EventoController.eventoController.commonSnackBar("Password", "Password Updated Successfully");
                }, child: const Text("Save",style: TextStyle(color: primaryTextColor),)),
                SizedBox(height: 80.h,),
              ],
            ),
